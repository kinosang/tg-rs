...
sourcesIndex["carapax"] = {"name":"","files":["app.rs","context.rs","dispatcher.rs","handler.rs","lib.rs","prelude.rs"]};
sourcesIndex["carapax_access"] = {"name":"","files":["handler.rs","lib.rs","policy.rs","rules.rs"]};
sourcesIndex["carapax_i18n"] = {"name":"","files":["lib.rs"]};
sourcesIndex["carapax_ratelimit"] = {"name":"","files":["direct.rs","keyed.rs","lib.rs"]};
sourcesIndex["carapax_session"] = {"name":"","dirs":[{"name":"store","files":["data.rs","fs.rs","mod.rs","redis.rs"]}],"files":["gc.rs","handler.rs","lib.rs","session.rs"]};
...
sourcesIndex["common_multipart_rfc7578"] = {"name":"","files":["client_.rs","error.rs","lib.rs"]};
...
sourcesIndex["evmap"] = {"name":"","files":["inner.rs","lib.rs","read.rs","shallow_copy.rs","write.rs"]};
...
sourcesIndex["gettext"] = {"name":"","files":["lib.rs","metadata.rs","parser.rs","plurals.rs"]};
...
sourcesIndex["hyper_multipart_rfc7578"] = {"name":"","files":["body.rs","lib.rs"]};
sourcesIndex["hyper_proxy"] = {"name":"","files":["lib.rs","stream.rs","tunnel.rs"]};
sourcesIndex["hyper_socks2"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["nonzero_ext"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["ratelimit_meter"] = {"name":"","dirs":[{"name":"algorithms","files":["gcra.rs","leaky_bucket.rs","mod.rs"]},{"name":"state","files":["direct.rs","keyed.rs","mod.rs"]},{"name":"test_utilities","files":["algorithms.rs","mod.rs","variants.rs"]},{"name":"thread_safety","files":["mod.rs"]}],"files":["errors.rs","example_algorithms.rs","instant.rs","lib.rs"]};
sourcesIndex["redis"] = {"name":"","files":["async.rs","client.rs","cmd.rs","commands.rs","connection.rs","lib.rs","macros.rs","parser.rs","script.rs","types.rs"]};
...
sourcesIndex["socks"] = {"name":"","files":["lib.rs","v4.rs","v5.rs","writev.rs"]};
...
sourcesIndex["tgbot"] = {"name":"","dirs":[{"name":"executor","files":["hyper.rs","mod.rs"]},{"name":"handler","files":["mod.rs","poll.rs","webhook.rs"]},{"name":"methods","dirs":[{"name":"answer","files":["callback_query.rs","inline_query.rs","mod.rs","pre_checkout_query.rs","shipping_query.rs"]},{"name":"chat","files":["delete_photo.rs","delete_sticker_set.rs","export_invite_link.rs","get.rs","get_administrators.rs","get_members_count.rs","leave.rs","mod.rs","pin_message.rs","set_description.rs","set_photo.rs","set_sticker_set.rs","set_title.rs","unpin_message.rs"]},{"name":"chat_member","files":["get.rs","kick.rs","mod.rs","promote.rs","restrict.rs","unban.rs"]},{"name":"game","files":["get_high_scores.rs","mod.rs","send.rs","set_score.rs"]},{"name":"message","dirs":[{"name":"edit","files":["caption.rs","live_location.rs","media.rs","mod.rs","reply_markup.rs","text.rs"]}],"files":["delete.rs","forward.rs","mod.rs","send.rs"]},{"name":"passport","files":["mod.rs","set_data_errors.rs"]},{"name":"send","files":["animation.rs","audio.rs","chat_action.rs","contact.rs","document.rs","invoice.rs","location.rs","media_group.rs","mod.rs","photo.rs","venue.rs","video.rs","video_note.rs","voice.rs"]},{"name":"sticker","files":["add_to_set.rs","delete_from_set.rs","get_set.rs","mod.rs","new_set.rs","send.rs","set_position_in_set.rs","upload_file.rs"]},{"name":"user","files":["get_me.rs","get_profile_photos.rs","mod.rs"]}],"files":["get_file.rs","method.rs","mod.rs","poll.rs","updates.rs"]},{"name":"request","files":["form.rs","mod.rs"]},{"name":"types","dirs":[{"name":"chat","files":["member.rs","mod.rs","photo.rs","raw.rs"]},{"name":"inline_mode","dirs":[{"name":"query_result","dirs":[{"name":"cached","files":["audio.rs","document.rs","gif.rs","mod.rs","mpeg4_gif.rs","photo.rs","sticker.rs","video.rs","voice.rs"]}],"files":["article.rs","audio.rs","contact.rs","document.rs","game.rs","gif.rs","location.rs","mod.rs","mpeg4_gif.rs","photo.rs","venue.rs","video.rs","voice.rs"]}],"files":["message_content.rs","mod.rs"]},{"name":"message","files":["data.rs","forward.rs","kind.rs","mod.rs","raw.rs","text.rs"]},{"name":"passport","files":["element.rs","error.rs","mod.rs"]},{"name":"reply_markup","files":["force_reply.rs","inline_keyboard.rs","mod.rs","reply_keyboard.rs"]}],"files":["animation.rs","audio.rs","callback_query.rs","contact.rs","document.rs","file.rs","games.rs","input_media.rs","location.rs","mod.rs","payments.rs","photo_size.rs","poll.rs","primitive.rs","response.rs","stickers.rs","update.rs","user.rs","venue.rs","video.rs","video_note.rs","voice.rs"]}],"files":["api.rs","lib.rs","never.rs","prelude.rs"]};
...
sourcesIndex["tokio_sync"] = {"name":"","dirs":[{"name":"mpsc","files":["block.rs","bounded.rs","chan.rs","list.rs","mod.rs","unbounded.rs"]},{"name":"task","files":["atomic_task.rs","mod.rs"]}],"files":["lib.rs","loom.rs","oneshot.rs","semaphore.rs","watch.rs"]};
...
sourcesIndex["typed_headers"] = {"name":"","dirs":[{"name":"impls","files":["accept.rs","accept_encoding.rs","allow.rs","auth_scheme.rs","authorization.rs","content_coding.rs","content_encoding.rs","content_length.rs","content_type.rs","credentials.rs","host.rs","http_date.rs","mod.rs","proxy_authorization.rs","quality.rs","retry_after.rs","token68.rs"]}],"files":["lib.rs","util.rs"]};
